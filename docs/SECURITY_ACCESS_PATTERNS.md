...
**Agents**: backend-dev, frontend-engineer, fullstack-lead, qa-tester, devops
...
- **backend-dev**: Implements complex distributed systems requiring database and infrastructure access
