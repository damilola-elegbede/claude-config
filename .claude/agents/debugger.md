...
complexity_triggers:
  intermittent_failures: "Bugs occurring <5qa-engineer% of the time, timing-dependent issues, race conditions"
...
- Intermittent failures that happen <5qa-engineer% of the time
