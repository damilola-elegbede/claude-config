...
scale_triggers:
  ...
  traffic_volume: ">50k requests/second or mission-critical systems"
  data_volume: ">100GB enterprise data or >10TB data architecture"
...
tool_restrictions:
  allowed: [Read, Write, Edit, MultiEdit, Glob, Grep, LS, WebFetch, WebSearch, TodoWrite, Task, Bash(read-only)]
