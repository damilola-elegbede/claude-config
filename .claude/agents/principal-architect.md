...
scale_triggers:
  user_count: ">100k users or enterprise-scale deployments"
  traffic_volume: ">10k requests/second or mission-critical systems"
  data_volume: ">10TB or complex data architecture requirements"
  geographic_distribution: "Multi-region deployments or global scaling requirements"
complexity_triggers:
