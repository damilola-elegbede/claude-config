...
escalation_from: [senior-dev, backend-dev, data-engineer]
parallel_compatible: [data-engineer, backend-dev, platform-engineer, performance-engineer, devops, qa-tester]
scale_triggers:
